...
def func(arac):
    ...
    def git():
        ...
        def irt_yon():
            ...
            if arac.hız > 40:
                arac.hız_katsayısı -= arac.hız_katsayısı / 10
            ...
            if arac.irtifa < 100 and arac.durak_sayaci == 0:                        # durak sayısı değişirse sıkıntı çıkarır     !!  
             arac.irtifa += random.uniform(0.007 , 0.009) * arac.hız_katsayısı
                ...
                arac.irtifa += random.uniform(0.005 , 0.007)  * arac.hız_katsayısı
        ...
        while round(arac.konum[0],5) != hedefx:
            ...
            arac.konum[1] += hiz_orantisi_y * zaman_sabiti * arac.hız_katsayısı

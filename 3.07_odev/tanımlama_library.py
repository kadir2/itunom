class Arac:
    def __init__(self, isim = "tanımsız", id=None, konum = [0, 0], hız = 0, hız_katsayısı = 1, yön = 0, irtifa = 0 , durak_sayaci = 0, duraklar = []):
        self.isim = isim
        self.id = id
        self.konum = konum
        self.hız = hız
...
class quadcopter(Arac):
    def __init__(self, isim = "tanımsız", id= None, konum = [0, 0], hız = 0, hız_katsayısı = 1, yön = 0, irtifa = 0, durak_sayaci = 0, duraklar = [], motor_durumu = [0, 0, 0, 0]):
        super().__init__(isim, id, konum, hız, hız_katsayısı, yön, irtifa, durak_sayaci, duraklar)
...
class fixedwing(Arac):
    def __init__(self, isim="tanımsız", id=None, konum=[0, 0], hız = 0, hız_katsayısı = 1, yön = 0, irtifa = 0, durak_sayaci = 0, duraklar = [], motor_sayısı = 1, motor_durumu = [0]):
        super().__init__(isim, id, konum, hız, hız_katsayısı, yön, irtifa , durak_sayaci, duraklar)
